# Generated by Django 3.1.1 on 2020-10-09 18:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('starting', models.DecimalField(decimal_places=2, max_digits=10, null=True)),
                ('image', models.CharField(blank=True, max_length=512, null=True)),
                ('bid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='auctions.bid')),
